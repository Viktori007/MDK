...
namespace MathQuiz
{
        ...
        public void StartTheQuiz()
    {
        ...
        private void ividedLeftLabel_Click(object sender, EventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (CheckTheAnswer())
            {
                ...
                timer1.Stop();
                MessageBox.Show("ты решил все верно!",
                                "Превосходно!");
            ...
            else
            {
                ...
                MessageBox.Show("Время закончилось :(", "Sorry!");
            ...
            if (timeLeft <= 5)
            {
                timeLabel.BackColor = Color.Tomato;
